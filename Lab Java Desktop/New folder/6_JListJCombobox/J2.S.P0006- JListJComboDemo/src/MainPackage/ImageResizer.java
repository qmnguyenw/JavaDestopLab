...
public class ImageResizer {
    ...
    /*
        Create a BufferedImageobject for the input image by calling the method read(File) of the ImageIO class.
        Create a BufferedImageobject for the output image with a desired width and height.
        Obtain a Graphics2D object from the output image’s BufferedImageobject.
